...
- `--site-mode simulate` is the default. It requires a login-measurement file and never queries
  current hardware. `live` loads a supplied file or captures one when it is absent.
