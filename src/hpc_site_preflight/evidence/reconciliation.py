...
RULES = (
    ...
    FieldRule(
        rule_id="documented_htcondor_submission_host",
        field_pattern="/htcondor/submission_host",
        allowed_sources=["documentation"],
        precedence=["documentation"],
        conflict_behavior="retain_note",
        unresolved_action="additional_documentation",
        action_id="htcondor_submission_policy_search",
        not_applicable_for=["slurm"],
    ),
    FieldRule(
        rule_id="documented_htcondor_machine_requirements",
        field_pattern="/htcondor/machine_requirements_supported",
        allowed_sources=["documentation"],
        precedence=["documentation"],
        conflict_behavior="retain_note",
        unresolved_action="additional_documentation",
    ...
    FieldRule(
        rule_id="documented_htcondor_dynamic_slots",
        field_pattern="/htcondor/dynamic_slots_enabled",
        allowed_sources=["documentation"],
        precedence=["documentation"],
        conflict_behavior="retain_note",
        unresolved_action="additional_documentation",
    ...
    FieldRule(
        rule_id="documented_htcondor_bulk_submission",
        field_pattern="/htcondor/bulk_submission_supported",
        allowed_sources=["documentation"],
        precedence=["documentation"],
        conflict_behavior="retain_note",
        unresolved_action="additional_documentation",
    ...
    FieldRule(
        rule_id="documented_htcondor_completion_email",
        field_pattern="/htcondor/completion_email_supported",
        allowed_sources=["documentation"],
        precedence=["documentation"],
        conflict_behavior="retain_note",
        unresolved_action="additional_documentation",
